...
//            totalPoints += stat.getFantasyPoints();
//        }
//        return totalPoints;
//    }
//
...
//    }
    ...
    private void addGoalieStats(JsonObject object) {
        ...
        GameStat saveSummary = new GameStat(date, 2017021244, player, saves, saveCount);
        GameStat winSummary = new GameStat(date, 2017021244, player, wins, winCount);
    ...
    private void addSkaterStats(JsonObject object) {
        ...
        LocalDate date = LocalDate.of(2017, 02, 01);
        GameStat goalSummary = new GameStat(date, 2017021244, player, goals, goalCount);
        GameStat assistSummary = new GameStat(date, 2017021244, player, assists, assistCount);
