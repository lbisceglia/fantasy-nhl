...
//        roster.addGoalie(Jones);
    ...
    public void testConstructor() {
        ...
        assertEquals(testTeam.getTeamName(), "Test Team");
        assertEquals(testTeam.getFantasyPoints(), 0);
    }
    ...
    @Test
    public void testGetFantasyPoints() {
    ...
    @Test
    public void testSetTeamNameEmptyString() {
        team1.setTeamName("");
        assertEquals(team1.getTeamName(), "Lorenzo's Team");
    }
